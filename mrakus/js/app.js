; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('.header__logo').find('img').attr( {src:'assets/images/logo/logo@2x.png',width:'185',height:'41'} );
              $('.header__logo.style2').find('img').attr( {src:'assets/images/logo/logo3@2x.png',width:'184',height:'42'} );

              $('.footer__logo').find('img').attr( {src:'assets/images/logo/logo2@2x.png',width:'184',height:'42'} );
          }   
      };
